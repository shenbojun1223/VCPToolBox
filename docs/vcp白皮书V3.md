...
- [十三、前端运行时](#十三前端运行时)
- [十四、Agent 原生生态](#十四agent-原生生态)
- [十五、容灾、安全与数据保障](#十五容灾安全与数据保障)
- [十六、自研引擎矩阵](#十六自研引擎矩阵)
- [十七、生态兼容性](#十七生态兼容性)
- [十八、VCP 的本质](#十八vcp-的本质)
...
### 13.13 浏览器运行时与 VCPChromeService
